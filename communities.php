<?php include 'includes/header.php' ?>
	...
	<div class="full-xs" id="viewportXS">
					...
					<div class="comms">
						<a href="https://www.facebook.com/groups/1587540454595219/"><h2>Club Seattle Runners Division (CSRD)</h2></a>						<img src="images/runners.jpeg" alt="runners-club" width="70px" height="70px">
	...
	<div class="mTabs" id="tabsM">
        ...
        <div class="categories" id="viewportM">
            <h1>Categories</h1>
            <div class="cat">
                <div class="types"><a href="networking.php">Professional Networking</a></div>
                <div class="types"><a href="environment.php">Environmental Activism</a></div>
	...
	<div class="categories" id="viewportL">
            <h1>Categories</h1>
            <div class="cat">
                <div class="types"><a href="networking.php">Professional Networking</a></div>
                <div class="types"><a href="environment.php">Environmental Activism</a></div>
